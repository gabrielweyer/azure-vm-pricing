...
λ  dotnet run --configuration Release -- --input <input-path> --culture <culture>
λ  dotnet run --configuration Release -- -i <input-path> -l <culture>
λ  dotnet run --configuration Release -- -i <input-path>
```
